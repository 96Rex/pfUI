pfUI:RegisterSkin("设置窗口(新)", "vanilla", function ()
  ...
  if OptionsFrameCategoryList then
	OptionsFrameCategoryList:SetHeight(400)
  ...
  if OptionsFrameSearchBox then
    OptionsFrameSearchBox:SetWidth(610)
	OptionsFrameSearchBox:ClearAllPoints()
    OptionsFrameSearchBox:SetPoint("TOPLEFT", OptionsFrame, "TOPLEFT", 16, -447)
    StripTextures(OptionsFrameSearchBox)
    CreateBackdrop(OptionsFrameSearchBox, nil, nil, 0.75)
  ...
  OptionsFrameDefaults:SetPoint("TOPLEFT", OptionsFrameSearchBox, "BOTTOMLEFT", 0, -7)
  
  OptionsFrameOkay:ClearAllPoints()
  OptionsFrameOkay:SetPoint("TOPRIGHT", OptionsFrameCancel, "TOPRIGHT", -100, 0)
  
  OptionsFrameCancel:ClearAllPoints()
  OptionsFrameCancel:SetPoint("TOPRIGHT", OptionsFrameSearchBox, "BOTTOMRIGHT", 0, -7)
  -- category buttons
  ...
  local function SkinControls()
    ...
    for i = 1, 20 do
      ...
      if not btn._pfSkinned then
        ...
        btn:SetBackdropColor(br, bg, bb, 0)
        ...
        HookScript(btn, "OnMouseDown", function()
          ...
          this:SetBackdropColor(br, bg, bb, 0)
